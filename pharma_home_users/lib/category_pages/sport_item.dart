...
class sport_item extends StatefulWidget {
  const sport_item({super.key});

  @override
  State<sport_item> createState() => _sport_itemState();
}

class _sport_itemState extends State<sport_item> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('مكملات رياضية'),
        centerTitle: true,
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('item_category', isEqualTo: 'مكملات رياضية')
            .snapshots(),
